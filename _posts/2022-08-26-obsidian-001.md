...
### 1.1 Organizing Information by PARA Method
...
#### 3.1.1 Read and Annotate in Zotero PDF Reader
- Using different color to annotate the reading materials.

#### 3.1.2 Scratch Annotation by Zotero Integration
...
#### 3.1.4 Export Notes into Any Formats
